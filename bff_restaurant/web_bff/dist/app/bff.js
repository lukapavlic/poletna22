...
exports.getRestaurantsMenu = exports.getRestaurantById = exports.getCustomerById = exports.getAllOrders = void 0;
...
function getRestaurantsMenu() {
    return axios_1.default({
        method: "get",
        url: `${process.env.RESTAURANT_URL}/restaurants`,
    }).then((response) => {
        return response.data.map((rawRestaurant) => {
            return {
                menu: rawRestaurant.menu,
                restaurantName: rawRestaurant.restaurantName,
            };
...
exports.getRestaurantsMenu = getRestaurantsMenu;
